...
class DatePickerPopupViewController: UIViewController {
    ...
    private let datePickerTopMargin: CGFloat = 18
    private let sitchOnOFFBottomMargin: CGFloat = -20
    ...
    private func setupLayouts () {
        ...
        NSLayoutConstraint.activate([
            ...
            datePicker.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: datePickerTopMargin),
        ...
        NSLayoutConstraint.activate([
            ...
            switchOnOff.trailingAnchor.constraint(equalTo: switchLabel.trailingAnchor, constant: sitchOnOFFBottomMargin)
        ])
    }
